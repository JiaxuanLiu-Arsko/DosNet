...
save_path = "/work/jxliu/e3nn/DOS_net/DosNet/data/" # data folder

strucure_path = "/work/jxliu/e3nn/DOS_net/DosNet/data/structure/" # sub folder of data folder
dos_raw_path = "/work/jxliu/e3nn/DOS_net/DosNet/data/dos_raw/" # sub folder of data folder
target_path = "/work/jxliu/e3nn/DOS_net/DosNet/data/" # data folder
